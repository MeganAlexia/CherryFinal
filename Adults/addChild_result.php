...
// Add the new child in the database
        if (isset($_SESSION['email'])) {
            try {
                ...
                "Enfant ajouté à votre charge. Redirection vers la page <a href=\"./accueil_adultes.php?page=profil\">Profil</a> ..." .
                "</div>";
