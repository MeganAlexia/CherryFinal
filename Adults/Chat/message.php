            ...
            <div class="row">
                <div class="col-sm-3 col-md-2">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        <li class="active"><a href="accueil_adultes.php?page=./Chat/message"><?php if ($totalNew != 0) {
        echo '<span class="badge pull-right">' . $totalNew . '</span>';
    } ?> Boîte de réception </a>
                        </li>
                        <li class=""><a href="accueil_adultes.php?page=./Chat/message-sent">Messages envoyés</a></li>
                    </ul>
                </div>
                <div class="col-sm-9 col-md-10">
                    <!-- Nav tabs -->
                            ...
                            <div class="list-group">
                                ...
                                foreach ($iterator as $item) {
                                    if (empty($item['deleteTarget']['S'])) {
                                        ...
                                        ?>
                                        <a href="./accueil_adultes.php?page=./Chat/read&id=<?php echo $item['id']['S']; ?>" class="list-group-item <?php
                            if (strcmp($item['new']['S'], "false") == 0) {
                                echo 'read';
                            }
                                        ?> ">
                                            ...
                                            <span class="name" style="min-width: 120px;
                                                  display: inline-block;"><?php echo stripslashes(htmlentities(trim($item['email']['S']))); ?></span> <span class=""><?php echo html_entity_decode($item['title']['S']); ?></span>
